...
//       </NavLink>
//       </ul>
//       <div   onClick={()=>navigate('/login')} className='flex item-center gap-4'>
//       {
  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <div className="flex items-center gap-4">
        ...
        <img onClick={() => setShowMenu(true)} className="w-6 md:hidden" src={assets.menu_icon} alt="Hamburger Menu" />
      </div>
